...
?>
	...
	<div class="section mt-60 csr-content">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h3>Business Philosophy: "F.I.R.S.T." - Establishing a Sustainable Company Full of Happiness</h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<h5>Product & package materials purchasing strategy</h5>
					<ul>
					...
					<h5>Public welfare sponsored activities</h5>
					<ul>
