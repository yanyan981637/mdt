		...
		<div class='container'>
			<div class='proj-nav'>
				<div class='c-card-carousel__controller o-animate-in-element js-animate-in-element' style='opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);'>	
					...
					<?php
						$sql ="SELECT menu_name ,file_name ,href_target FROM `ows_menu_test` where menu_class='main' and is_online=1 and lang='en' and father_menu_id=? and menu_order < ? order by menu_order DESC limit 1";
						...
						$sql ="SELECT menu_name ,file_name ,href_target FROM `ows_menu_test` where menu_class='main' and is_online=1 and lang='en' and father_menu_id=? and menu_order > ? order by menu_order limit 1";
		...
		<div class="container scd-foot">
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<?php
						$sqlPM ="Select menu_name, file_name, href_target From `ows_menu_test` Where menu_class='policy' And father_menu_id is NULL And is_online=1 And lang='en' Order By menu_order ASC ";
