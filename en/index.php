		...
		<div class="row justify-content-center">
			<div class="col-md-10">
				<div class="call-box-4">
					...
					<p class="ContImp">As a pioneering force in the automotive electronics and AIoT industries, MiTAC Digital Technology (MDT) has integrated its expertise in the Mobility as a Service (MaaS) domain with innovative edge-computing platform design capabilities to provide industrial and automotive grade product solutions for enterprise and consumer applications.</p>



					<p class="ContImp">Our commitment to innovation extends to versatile processor development, supporting Intel x86, ARM, and Linux architectures to craft industrial computer solutions compatible with Windows or Android systems. Leveraging Edge AI alongside VisionAI technology and cloud computing, we propel our customers towards new and exciting directions in industrial computing solutions, reflecting the highest standards of quality and ingenuity.</p>



					<p class="ContImp">MDT persists in delivering comprehensive hardware and software integrated solutions, harnessing state-of-the-art technologies to solidify its position as a trusted leader in automotive electronics and IoT solutions.</p>



					<p class="ContImp">Our knowledgeable technical support teams, rigorous quality management processes, and ISO-compliant manufacturing facilities assure the highest product quality and reliability. To meet the rapid global market shifts and ensure effective product distribution across five continents, we have extended our R&D capacity and manufacturing proficiency by investing in a new facility at Hsinchu Science Park in 2020. This expansion enables us to collaborate closely with industry supply chains to create a smarter, safer, and more efficient smart living environment, enhancing our ability to deliver cutting-edge solutions worldwide.</p>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="areas">
				<div class="item item--itokin">
					<a href="dashcam-recorder.php" data-track-category="トップページ" data-track-action="ITOKIN CORPORATE SITE">
						<div class="txt-wrap">
							<h3 class="FC_W ttl">
								<h2 class="em h4 mb-20"><i class="fa fa-chevron-right" aria-hidden="true"></i> Smart Mobility</h2><span></span>
							</h3>
							<p class="leads">
				...
				<div class="item item--second">
					<a href="tablet.php" data-track-category="トップページ" data-track-action="ENFÖLD BRAND SITE / EC SITE">
						<div class="txt-wrap">
							<h3 class="FC_W ttl">
								<h2 class="em h4 mb-20"><i class="fa fa-chevron-right" aria-hidden="true"></i> Smart Industries</h2><span></span>
							</h3>
							<p class="leads">
				...
				<div class="item item--enfold">
					<a href="outdoor-luminaires.php" data-track-category="トップページ" data-track-action="ENFÖLD BRAND SITE / EC SITE">
						<div class="txt-wrap">
							<h3 class="FC_W ttl">
								<h2 class="em h4 mb-20"><i class="fa fa-chevron-right" aria-hidden="true"></i> Smart IOT</h2><span></span>
							</h3>
							<p class="leads">
