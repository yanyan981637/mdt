...
?>
	...
	<div class="section" >	
		<div class="container  privacy-policy">
			<div class="row">
				<div class="col-12">
					<h1 class="FC_mdtB">Privacy Policy</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container" style="border-top: solid 4px #313139;">
			...
			<div class="row policyCont">
				<div class="col-md-12 mt-30">
					<p>This privacy policy explains how MiTAC Digital Technology Corporation (‘‘MiTAC’’ or ‘‘We’’) uses personal data from and about you, on the portal site operated by MiTAC, by phone, email, or otherwise when you visit our website, or use the services provided on and through our website, including purchasing goods, services or providing after-sales services.</p>
					<p>MiTAC is committed to protecting your personal data and being transparent about what information it holds. MiTAC understands its obligations to help you understand how and why MiTAC processes your personal data. This policy tells you about the why, what, how, and when in relation to MiTAC’s collection and processing of your personal data.</p>
					<h5>PURPOSE AND BASIS OF MITAC’S COLLECTION AND PROCESSING OF YOUR PERSONAL DATA</h5>
					<p>We collect and process your personal data for purpose of performing our obligations under the membership agreement, license agreement and/or purchase agreement with you.</p>
					<p>We use the personal data collected from you for purpose of delivering our service to you, completing purchase orders, facilitating payments, rendering of necessary support, repair and/or maintenance services, and, upon your consent, providing you with updated news and marketing information on the products and services offered by MiTAC.</p>
					<p>We also use your personal data to respond to you when you contact us.</p>
					<p>&nbsp;</p>
					<h5>TYPE OF DATA MITAC COLLECTS ABOUT YOU</h5>
					...
					<ul class="list-style">
						...
						<li><i class="fa fa-caret-right" aria-hidden="true"></i>Business information details such as information provided in the course of the contractual relationship between you and MiTAC, or otherwise voluntarily provided by you;</li>
					...
					<ol>
						...
						<li>Our website also employs cookies and similar technologies placed by our carefully selected third party partners, including but not limited to Google, to manage our commercial relationship with those partners.</li>
					...
					<ol>
						<li>Your personal data collected by MiTAC may be shared with MiTAC International Corp. and companies within MiTAC group so as to allow MiTAC to carry out the purposes stated above.</li>
					...
					<p>Where data needs to be transferred outside the country, MiTAC will ensure that all such transfers are in compliance with the terms of the applicable laws and the relevant regulations. Where transfers are to be made outside of the country, MiTAC will ensure that the designation country(ies) has data protection laws assessed as adequate by the country or where adequate safeguards are in place.</p>
					...
					<ol>
						...
						<li>You have the right to lodge a complaint with the authority should you believe that MiTAC has violated your privacy right through inappropriate use of your personal data and has failed to promptly cure such violation upon receipt of your request for cure.</li>
					</ol>
					...
					Hsinchu, Taiwan <br/>
					Email: <a href="mailto:privacy@mitac.com" target="_blank">privacy@mitac.com</a>
					</address>
				</div>
			</div>
