		...
		<div class="container">
			<div class="row">	
				...
				<div class="col-md-6 col-lg-5 order-1 order-md-2 mb-20">
					<img src="../images/auxiliary_software/MiVue_Pro-banner.png" alt="MiVue Pro Banner" class="rounded mx-auto d-block img-fluid auxiliary_software_img">
			  </div>	
		  </div>
			...
			<div class="row">	
				...
				<div class="col-md-6 col-lg-7 mt_30_ order-2 order-md-1">
					<div class="row">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 mt-30">
							<div class="auxiliary-software-icon text-center">
								<img class="rounded img-fluid" src="../images/auxiliary_software/icon_Real_Time_Event_Notification.png" alt="Real-time event notification">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 mt-30">
							<div class="auxiliary-software-icon text-center">
								<img class="rounded img-fluid" src="../images/auxiliary_software/icon_Find_Parked_Car_Location.png" alt="Real-time GPS tracking / parked car location finding">
				...
				<div class="col-md-6 col-lg-5 order-1 order-md-2 mb-20">
					<img src="../images/auxiliary_software/MioNext-banner.png" alt="MioNext Banner" class="rounded mx-auto d-block img-fluid auxiliary_software_img">
			  </div>
			</div>
			<div class="col-md-12 mt-30">
				<a class="btn btn-primary btn-lg btn-round" href="https://www.mio.com/tw/products/mionextapp" target="_blank">Learn More</a>
				<a class="btn btn-fill-black-b btn-lg  btn-round" href="https://www.mio.com/tw/misentry-12t" target="_blank">Apply to Connected Dashcam</a>
