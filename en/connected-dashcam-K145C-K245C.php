				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td class="data tc" colspan="2">Emergency recording button for driver to manually trigger 60s recording</td>
						</tr>
						<tr>
		...
		<div class="container">
			...
			<div class="row">
			  <div class="col-md-4 align-items-stretch tc">	
					<div class="accsBox">	
						...
						<img src="../images/connected_dashcam/pdt/K145C_OBD_power_power.png" alt="Accessories OBD POWER CABLE"/>
						<p class="st2">
						Sold separately
						</p>
					</div>
				...
				<div class="col-md-4 align-items-stretch tc">	
					<div class="accsBox">	
						<h5>ENTRY CABLE</h5>
						<img src="../images/connected_dashcam/pdt/K145C_Entry_cable.png" alt="Accessories ENTRY CABLE" />
						<p class="st2">
							Standard accessory
						</p>
					</div>
				...
				<div class="col-md-4 align-items-stretch tc">	
					<div class="accsBox">	
						<h5>PREMIUM CABLE</h5>
						<img src="../images/connected_dashcam/pdt/K245C_Preminum.png" alt="Accessories PREMIUM CABLE" />
						<p class="st2">
							Sold separately
						</p>
					</div>
			...
			<div class="row">
			  <div class="col-md-4 align-items-stretch tc">	
					<div class="accsBox">	
						<h5>CABLE CAP</h5>
						<img src="../images/connected_dashcam/pdt/K145C_cable_cap.png" alt="Accessories CABLE CAP" />
						<p class="st2">
							Sold separately
						</p>
					</div>
