...
<!-- 更換banner -->
  ...
  <div class="section mid-height-incNav over-hide" id="embedded_motherboard_bn">	
		<div class="parallax" style="background-image: url('../images/embedded/embedded_motherboard_bn.jpg')"></div>
    <div class="hero-center-wrap z-bigger">
			<div class="container color-white hero-text big-text text-center">
				<div class="row">
					<div class="col-md-12 align-self-center">	
						<h1 class="color-white">Embedded Motherboard</h1>
            <h3 class="h4">Industrial-grade Embedded motherboard for various vertical applications</h3>
					</div>	
  ...
  <!-- 更換圖片 -->
  <div class="section" id="embedded_motherboard">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 mt-30">
          <div class="dashcam-recorder-icon text-center">
            <img class="rounded img-fluid" src="../images/embedded/EMC_Class_B.png" alt="EMC Class B">
            <p>EMC Class B</p>
          </div>
        </div>
        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 mt-30">
          <div class="dashcam-recorder-icon text-center">
            <img class="rounded img-fluid" src="../images/embedded/All_Solid_Capacitor.png" alt="All Solid Capacitor">
            <p>All Solid Capacitor</p>
          </div>
        </div>
      </div>
