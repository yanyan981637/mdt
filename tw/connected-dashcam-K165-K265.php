			...
			<div class="row pt-30">
				<div class="col-md-6">	
					...
					<div class="pdt_btn tc">
						<a href="../Downloads/202411/Mitac K165-K265_datasheet_20241111.pdf" target="_blank" class="btn-long btn-fill-lightBlue btn-round mb-10" style="">下載產品規格書</a>
				...
				<div class="col-md-6">	
					...
					<div class="pdt_name pt_pb_1r">
						<h1 class="FC_mdtB h1">K165/K265</h1>
						<p>一體式7路攝影聯網型行車記錄器</p>
					</div>
					<ul class="mt_2 pl-30">
						<li>最高支援同時7路錄影</li>
