    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 mt-30 text-center">
          <a class="btn btn-primary btn-lg btn-round" href="https://www.mio.com/en_eu/products/navigation/car-navigation" target="_blank">了解更多</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section mt-10vh" id="off-road-navigation">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 mt-30 text-center">
          <a class="btn btn-primary btn-lg btn-round" href="#" target="_blank">了解更多</a>
        </div>
      </div>
    </div>
  </div>
