    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          ...
          <div class="show-mobile img">
            <img src="../images/home/2024_IAA_Transportation_mdt_m.jpg" class="show-mobile" alt="">
            <div class="banner-text">
              <h5></h5>
              <p></p>
            </div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="call-box-4">
          ...
          <p class="ContImp">
            神達數位深耕車用電子及嵌入式系統解決方案領域，為滿足客戶多元技術整合產品之需求，憑藉在Maas(Mobility as a
            Service)領域的專業能力以及先進的邊緣運算平台設計能力，提供跨足涵蓋消費性及企業級的工規與車用產品解決方案。
          </p>
          <p class="ContImp">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6 mb-30" data-scroll-reveal="enter bottom move 40px over 0.8s after 0.2s">
        <div class="pricing pt_pb_1r background-white borderTop_B">
          ...
          <div class="pricing-img"><a href="press-events-20240513.php"><img src="../images/press_news/20240513/iso.png"
                alt="神達數位股份有限公司通過TUV NORD Taiwan ISO/SAE 21434認證，強化車載產品網絡安全"></a></div>
        </div>
      </div>
      <div class="clearfix hidden-xs"></div>
