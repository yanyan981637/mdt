    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="call-box-4">
          ...
          <p class="ContImp">
            我們以Edge AI邊緣運算技術為基礎，整合深耕多年的影像AI及聯網技術，提供跨產業的創新解決方案。建立同時具備Intel X86、ARM架構下多元的處理器開發能力，可同時開發Windows、Android、Linux 或RTOS系統的多樣化工業電腦解決方案。面對數位轉型的浪潮，神達數位也將持續以卓越的先進科技，提供客戶全方位並整合軟硬體需求的解決方案，成為一個廣受信賴的車用電子和智聯網解决方案的領導廠商。
          </p>
          <p class="ContImp">
